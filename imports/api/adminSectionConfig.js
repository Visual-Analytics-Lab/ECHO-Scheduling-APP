...
const getSectionConfig = (collections, colData, rowData) => ({
  ...
  Specialists: {
    ...
    popupFields: () => [
      ...
      { name: "phone",                label: "Primary Phone Number",                                      colSpan: 1 },
      { name: "phone",                label: "Secondry Phone Number",                                     colSpan: 1 },
  ...
  "Participant Groups": {
    ...
    popupFields: () => [
      ...
      { name: "contact_name", label: "Primary Contact Name",                                              colSpan: 1 },
  ...
  Semesters: {
    ...
    popupFields: () => [
      ...
      { name: "description", label: "Description",                                           rowSpan: 3 },
    ],
